; This is not my code but it is simpler than using points as it uses angle and origin to define a Rectangle
; Code from: https://sicp-solutions.net/post/sicp-solution-exercise-2-3/
